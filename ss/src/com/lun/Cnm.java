...
public class Cnm {
	public static void main(String arg[]) throws IOException{
		fangfa(5,"D:/pr.png","255,0,0","0,0,255");
	}

	public static void fangfa(int version,String path,String startRgb,String endRgb) throws IOException{ 
